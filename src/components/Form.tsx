  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center relative">
        {loading && (
          <p className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-white bg-opacity-50 z-10">
            <span className="loading loading-dots loading-lg" style={{ color: "#24a9a6" }}></span>
          </p>
        )}
